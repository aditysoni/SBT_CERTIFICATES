...
contract SBT is ERC4973 {
   ...
   function issue(address _issuee, string memory _name , string memory _category , uint256 _rank ) external onlyOwner {
        require(count<=100 , "can't issue more than 100 certificates ");  //can't issue more than 100 certificates 
